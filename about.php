...
<body class="" style="background-color: #00ccff;">
    <container>
        ...
        <div>
            <!--- devloper Details start --->
            <div class="container">
                <div class="row">
                    <div class="col mt-5 ">
                        <div class="card border border-0" style="width: 18rem; background-color:#00ccff;">
                            <img src="image/dev.jfif" class="card-img-top rounded-circle   " alt="...">
                    ...
                    <div class="col mt-5">
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row g-0">
                                ...
                                <div class="col-12">
                                    <div class="card-body">
                                        <h5 class="card-title">Developed By Rating Rishu</h5>
                                        <p class="card-text p-3 mb-2 bg-dark text-white">Apna Bazaar is an e-commerce
                                            Website that sales Products
                                            like grocery, Homecare, Personalcase, 99Store, Artificial Jewellery,
                                            Shoes and More.
                                            <br>
                                            here you can get best Products at best Price.

                                        </p>
                                        <section class="mb-4">
                                            <!-- Facebook -->
                                            <a class="btn text-white btn-floating m-3"
                                                style="background-color: #3b5998;"
                                                href="https://www.facebook.com/rishabh.rai.75436?mibextid=ZbWKwL"
                                                role="button"><i class="fab fa-facebook-f"></i></a>

                                            <!-- Twitter -->
                                            <a class="btn text-white btn-floating m-3"
                                                style="background-color: #55acee;"
                                                href="https://twitter.com/Rishabh68624008?t=w2sDIzpgZM1mFKbQPq33mw&s=09"
                                            ...
                                            <a class="btn text-white btn-floating m-3"
                                                ...
                                                href="https://www.instagram.com/invites/contact/?i=19uf7gad58grq&utm_content=36gfk31"
                                                role="button"><i class="fab fa-instagram"></i></a>

                                            <!-- Linkedin -->
                                            <a class="btn text-white btn-floating m-3"
                                                style="background-color: #0082ca;"
                                                href="https://www.linkedin.com/in/rishabh-rai-409118174"
                                                role="button"><i class="fab fa-linkedin-in"></i></a>
                                            <!-- Github -->
                                            <a class="btn text-white btn-floating m-3"
                                                style="background-color: #333333;"
                                                href="https://github.com/RatingRishu/" role="button"><i
